<?php
	...
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='.head-title, input[type="submit"], .scrollup i, .footer .custom-social-icons i, nav.woocommerce-MyAccount-navigation ul li, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce span.onsale, .sidebar input[type="submit"], .sidebar h3, .sidebar .custom-social-icons i, .date-monthwrap, .hvr-sweep-to-right:before, .footer .tagcloud a:hover, .sidebar .tagcloud a, .pagination span, .pagination a, #comments a.comment-reply-link, .sidebar .woocommerce-product-search button, .sidebar .widget_price_filter .ui-slider .ui-slider-range, .sidebar .widget_price_filter .ui-slider .ui-slider-handle, .footer .widget_price_filter .ui-slider .ui-slider-range, .footer .widget_price_filter .ui-slider .ui-slider-handle, .footer .woocommerce-product-search button, .footer a.custom_read_more, .sidebar a.custom_read_more:hover, .nav-previous a, .nav-next a, .woocommerce nav.woocommerce-pagination ul li a, #preloader, .footer .wp-block-search .wp-block-search__button, .sidebar .wp-block-search .wp-block-search__button, .sidebar .wp-block-search .wp-block-search__label{';
			$vw_newspaper_custom_css .='background-color: '.esc_attr($vw_newspaper_first_color).';';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='#comments input[type="submit"].submit, .sidebar ul li::before, .sidebar ul.cart_list li::before, .sidebar ul.product_list_widget li::before{';
			$vw_newspaper_custom_css .='background-color: '.esc_attr($vw_newspaper_first_color).'!important;';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='a, .search-box i, .footer h3, .metabox span i, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title, .footer li a:hover, .sidebar ul li a:hover, .main-navigation a:hover, .main-navigation ul.sub-menu a:hover, .entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, .toggle-nav i, .single-post .metabox:hover a, .service-box:hover h2 a, .service-box:hover .metabox a, .headline h2 a:hover, .main-content-box:hover h3 a, .main-content-box:hover .date-box a, .footer .wp-block-search .wp-block-search__label{';
			$vw_newspaper_custom_css .='color: '.esc_attr($vw_newspaper_first_color).';';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='{';
			$vw_newspaper_custom_css .='border-color: '.esc_attr($vw_newspaper_first_color).'!important;';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='nav.woocommerce-MyAccount-navigation ul li:before{';
			$vw_newspaper_custom_css .='border-left-color: '.esc_attr($vw_newspaper_first_color).';';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='.main-navigation ul ul{';
			$vw_newspaper_custom_css .='border-top-color: '.esc_attr($vw_newspaper_first_color).';';
		$vw_newspaper_custom_css .='}';
	}
	if($vw_newspaper_first_color != false){
		$vw_newspaper_custom_css .='.main-navigation ul ul{';
			$vw_newspaper_custom_css .='border-bottom-color: '.esc_attr($vw_newspaper_first_color).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_second_color != false || $vw_newspaper_third_color != false){
		...
		background: linear-gradient(to right, '.esc_attr($vw_newspaper_second_color).', '.esc_attr($vw_newspaper_third_color).');
		}';
	}
    ...
    if($vw_newspaper_theme_lay == 'Boxed'){
		...
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='right: 100px;';
		$vw_newspaper_custom_css .='}';
		$vw_newspaper_custom_css .='.scrollup.left i{';
			$vw_newspaper_custom_css .='left: 100px;';
		$vw_newspaper_custom_css .='}';
		...
		$vw_newspaper_custom_css .='}';
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='right: 30px;';
		$vw_newspaper_custom_css .='}';
		$vw_newspaper_custom_css .='.scrollup.left i{';
			$vw_newspaper_custom_css .='left: 30px;';
		$vw_newspaper_custom_css .='}';
    ...
    if($vw_newspaper_theme_lay == 'Default'){
		...
		$vw_newspaper_custom_css .='.blogbutton-small{';
			$vw_newspaper_custom_css .='margin: 0; display: inline-block;';
		$vw_newspaper_custom_css .='}';
		$vw_newspaper_custom_css .='.service-box h2.section-title{';
			$vw_newspaper_custom_css .='border-bottom: none;';
		$vw_newspaper_custom_css .='}';
	...
	if($vw_newspaper_resp_stickyheader == true && get_theme_mod( 'vw_newspaper_sticky_header',false) != true){
    	$vw_newspaper_custom_css .='.header-fixed{';
			$vw_newspaper_custom_css .='position:static;';
		$vw_newspaper_custom_css .='} ';
	}
    if($vw_newspaper_resp_stickyheader == true){
    	$vw_newspaper_custom_css .='@media screen and (max-width:575px) {';
		$vw_newspaper_custom_css .='.header-fixed{';
			$vw_newspaper_custom_css .='position:fixed;';
		$vw_newspaper_custom_css .='} }';
	...
	if($vw_newspaper_resp_scroll_top == true && get_theme_mod( 'vw_newspaper_hide_show_scroll',true) != true){
    	$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='visibility:hidden !important;';
		$vw_newspaper_custom_css .='} ';
	}
    if($vw_newspaper_resp_scroll_top == true){
    	$vw_newspaper_custom_css .='@media screen and (max-width:575px) {';
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='visibility:visible !important;';
		$vw_newspaper_custom_css .='} }';
	...
	if($vw_newspaper_sticky_header_padding != false){
		$vw_newspaper_custom_css .='.header-fixed{';
			$vw_newspaper_custom_css .='padding: '.esc_attr($vw_newspaper_sticky_header_padding).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_search_font_size != false){
		$vw_newspaper_custom_css .='.search-box i{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_search_font_size).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_button_padding_top_bottom != false || $vw_newspaper_button_padding_left_right != false){
		$vw_newspaper_custom_css .='.blogbutton-small{';
			$vw_newspaper_custom_css .='padding-top: '.esc_attr($vw_newspaper_button_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_newspaper_button_padding_top_bottom).';padding-left: '.esc_attr($vw_newspaper_button_padding_left_right).';padding-right: '.esc_attr($vw_newspaper_button_padding_left_right).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_button_border_radius != false){
		$vw_newspaper_custom_css .='.blogbutton-small,.hvr-sweep-to-right:before{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_button_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}
	...
	$vw_newspaper_copyright_font_size = get_theme_mod('vw_newspaper_copyright_font_size');
	if($vw_newspaper_copyright_font_size != false){
		$vw_newspaper_custom_css .='.copyright p{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_copyright_font_size).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_copyright_padding_top_bottom != false){
		$vw_newspaper_custom_css .='#footer-2{';
			$vw_newspaper_custom_css .='padding-top: '.esc_attr($vw_newspaper_copyright_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_newspaper_copyright_padding_top_bottom).';';
		$vw_newspaper_custom_css .='}';
	}

	$vw_newspaper_copyright_alignment = get_theme_mod('vw_newspaper_copyright_alignment');
	if($vw_newspaper_copyright_alignment != false){
		$vw_newspaper_custom_css .='.copyright p{';
			$vw_newspaper_custom_css .='text-align: '.esc_attr($vw_newspaper_copyright_alignment).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_scroll_to_top_font_size != false){
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_scroll_to_top_font_size).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_scroll_to_top_padding != false){
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='padding-top: '.esc_attr($vw_newspaper_scroll_to_top_padding).';padding-bottom: '.esc_attr($vw_newspaper_scroll_to_top_padding).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_scroll_to_top_width != false){
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='width: '.esc_attr($vw_newspaper_scroll_to_top_width).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_scroll_to_top_height != false){
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='height: '.esc_attr($vw_newspaper_scroll_to_top_height).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_scroll_to_top_border_radius != false){
		$vw_newspaper_custom_css .='.scrollup i{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_scroll_to_top_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_social_icon_font_size != false){
		$vw_newspaper_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i, .footer-2 .custom-social-icons i{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_social_icon_font_size).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_social_icon_padding != false){
		$vw_newspaper_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_newspaper_custom_css .='padding: '.esc_attr($vw_newspaper_social_icon_padding).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_social_icon_width != false){
		$vw_newspaper_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_newspaper_custom_css .='width: '.esc_attr($vw_newspaper_social_icon_width).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_social_icon_height != false){
		$vw_newspaper_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_newspaper_custom_css .='height: '.esc_attr($vw_newspaper_social_icon_height).';';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_social_icon_border_radius != false){
		$vw_newspaper_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_social_icon_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_products_padding_top_bottom != false){
		$vw_newspaper_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_newspaper_custom_css .='padding-top: '.esc_attr($vw_newspaper_products_padding_top_bottom).'!important; padding-bottom: '.esc_attr($vw_newspaper_products_padding_top_bottom).'!important;';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_products_padding_left_right != false){
		$vw_newspaper_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_newspaper_custom_css .='padding-left: '.esc_attr($vw_newspaper_products_padding_left_right).'!important; padding-right: '.esc_attr($vw_newspaper_products_padding_left_right).'!important;';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_products_box_shadow != false){
		$vw_newspaper_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_newspaper_custom_css .='box-shadow: '.esc_attr($vw_newspaper_products_box_shadow).'px '.esc_attr($vw_newspaper_products_box_shadow).'px '.esc_attr($vw_newspaper_products_box_shadow).'px #ddd;';
		$vw_newspaper_custom_css .='}';
	}
	...
	if($vw_newspaper_products_border_radius != false){
		$vw_newspaper_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_products_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}

	$vw_newspaper_products_button_border_radius = get_theme_mod('vw_newspaper_products_button_border_radius');
	if($vw_newspaper_products_button_border_radius != false){
		$vw_newspaper_custom_css .='.woocommerce ul.products li.product .button, a.checkout-button.button.alt.wc-forward,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_products_button_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}

	$vw_newspaper_woocommerce_sale_font_size = get_theme_mod('vw_newspaper_woocommerce_sale_font_size');
	if($vw_newspaper_woocommerce_sale_font_size != false){
		$vw_newspaper_custom_css .='.woocommerce span.onsale{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_woocommerce_sale_font_size).';';
		$vw_newspaper_custom_css .='}';
	}

	$vw_newspaper_woocommerce_sale_border_radius = get_theme_mod('vw_newspaper_woocommerce_sale_border_radius', 100);
	if($vw_newspaper_woocommerce_sale_border_radius != false){
		$vw_newspaper_custom_css .='.woocommerce span.onsale{';
			$vw_newspaper_custom_css .='border-radius: '.esc_attr($vw_newspaper_woocommerce_sale_border_radius).'px;';
		$vw_newspaper_custom_css .='}';
	}
	...
	$vw_newspaper_site_title_font_size = get_theme_mod('vw_newspaper_site_title_font_size');
	if($vw_newspaper_site_title_font_size != false){
		$vw_newspaper_custom_css .='.logo h1 a, .logo p.site-title a{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_site_title_font_size).';';
		$vw_newspaper_custom_css .='}';
	}

	// Site tagline Font Size
	$vw_newspaper_site_tagline_font_size = get_theme_mod('vw_newspaper_site_tagline_font_size');
	if($vw_newspaper_site_tagline_font_size != false){
		$vw_newspaper_custom_css .='.logo p.site-description{';
			$vw_newspaper_custom_css .='font-size: '.esc_attr($vw_newspaper_site_tagline_font_size).';';
		$vw_newspaper_custom_css .='}';
	}

	/*------------------ Preloader Background Color  -------------------*/

	$vw_newspaper_preloader_bg_color = get_theme_mod('vw_newspaper_preloader_bg_color');
	if($vw_newspaper_preloader_bg_color != false){
		$vw_newspaper_custom_css .='#preloader{';
			$vw_newspaper_custom_css .='background-color: '.esc_attr($vw_newspaper_preloader_bg_color).';';
		$vw_newspaper_custom_css .='}';
	}

	$vw_newspaper_preloader_border_color = get_theme_mod('vw_newspaper_preloader_border_color');
	if($vw_newspaper_preloader_border_color != false){
		$vw_newspaper_custom_css .='.loader-line{';
			$vw_newspaper_custom_css .='border-color: '.esc_attr($vw_newspaper_preloader_border_color).'!important;';
		$vw_newspaper_custom_css .='}';
	}
