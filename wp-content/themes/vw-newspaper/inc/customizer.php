...
function vw_newspaper_customize_register( $wp_customize ) {
	...
	$VWNewspaperParentPanel = new VW_Newspaper_WP_Customize_Panel( $wp_customize, 'vw_newspaper_panel_id', array(
		...
		'theme_supports' => '',
		'title' => esc_html__( 'VW Settings', 'vw-newspaper' ),
		'priority' => 10,
	));

	$wp_customize->add_section( 'vw_newspaper_left_right', array(
    	'title'      => esc_html__( 'General Settings', 'vw-newspaper' ),
	...
	$wp_customize->add_setting('vw_newspaper_preloader_bg_color', array(
        'default'           => '#fb9812',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_newspaper_preloader_bg_color', array(
        'label'    => __('Pre-Loader Background Color', 'vw-newspaper'),
        'section'  => 'vw_newspaper_left_right',
    )));

    $wp_customize->add_setting('vw_newspaper_preloader_border_color', array(
        'default'           => '#ffffff',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_newspaper_preloader_border_color', array(
        'label'    => __('Pre-Loader Border Color', 'vw-newspaper'),
        'section'  => 'vw_newspaper_left_right',
    )));
    ...
    $wp_customize->add_setting('vw_newspaper_search_icon',array(
        'default'   => 'fas fa-search',
        'sanitize_callback' => 'sanitize_text_field'
    )); 
    $wp_customize->add_control(new VW_Newspaper_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_newspaper_search_icon',array(
        'label' => __('Add Search Icon','vw-newspaper'),
        'transport' => 'refresh',
        'section'   => 'vw_newspaper_headline_section',
        'setting'   => 'vw_newspaper_search_icon',
        'type'      => 'icon'
    )));

    $wp_customize->add_setting('vw_newspaper_search_close_icon',array(
        'default'   => 'fa fa-window-close',
        'sanitize_callback' => 'sanitize_text_field'
    )); 
    $wp_customize->add_control(new VW_Newspaper_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_newspaper_search_close_icon',array(
        'label' => __('Add Search Close Icon','vw-newspaper'),
        'transport' => 'refresh',
        'section'   => 'vw_newspaper_headline_section',
        'setting'   => 'vw_newspaper_search_close_icon',
        'type'      => 'icon'
    )));
    ...
    $wp_customize->add_setting( 'vw_newspaper_toggle_time',array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_newspaper_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Newspaper_Toggle_Switch_Custom_Control( $wp_customize, 'vw_newspaper_toggle_time',array(
        'label' => esc_html__( 'Time','vw-newspaper' ),
        'section' => 'vw_newspaper_post_settings'
    )));

    $wp_customize->add_setting( 'vw_newspaper_featured_image_hide_show',array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_newspaper_switch_sanitization'
    ));
    $wp_customize->add_control( new VW_Newspaper_Toggle_Switch_Custom_Control( $wp_customize, 'vw_newspaper_featured_image_hide_show', array(
        'label' => esc_html__( 'Featured Image','vw-newspaper' ),
        'section' => 'vw_newspaper_post_settings'
    )));
    ...
    $wp_customize->add_setting('vw_newspaper_meta_field_separator',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_newspaper_meta_field_separator',array(
        'label' => __('Add Meta Separator','vw-newspaper'),
        'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','vw-newspaper'),
        'section'=> 'vw_newspaper_post_settings',
        'type'=> 'text'
    ));
    ...
    $wp_customize->add_setting('vw_newspaper_button_text',array(
		'default'=> esc_html__( 'Read More', 'vw-newspaper' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
    ...
    $wp_customize->add_setting('vw_newspaper_copyright_font_size',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_newspaper_copyright_font_size',array(
        'label' => __('Copyright Font Size','vw-newspaper'),
        'description'   => __('Enter a value in pixels. Example:20px','vw-newspaper'),
        'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-newspaper' ),
        ),
	...
	$wp_customize->add_setting('vw_newspaper_copyright_alignment',array(
        'default' => 'center',
        'sanitize_callback' => 'vw_newspaper_sanitize_choices'
	));
	$wp_customize->add_control(new VW_Newspaper_Image_Radio_Control($wp_customize, 'vw_newspaper_copyright_alignment', array(
        'type' => 'select',
        'label' => __('Copyright Alignment','vw-newspaper'),
        'section' => 'vw_newspaper_footer',
        'settings' => 'vw_newspaper_copyright_alignment',
        'choices' => array(
    ...
    //Selective Refresh
    $wp_customize->selective_refresh->add_partial( 'vw_newspaper_woocommerce_shop_page_sidebar', array( 'selector' => '.post-type-archive-product .sidebar', 
        'render_callback' => 'vw_newspaper_customize_partial_vw_newspaper_woocommerce_shop_page_sidebar', ) );
    ...
    //Selective Refresh
    $wp_customize->selective_refresh->add_partial( 'vw_newspaper_woocommerce_single_product_page_sidebar', array( 'selector' => '.single-product .sidebar', 
        'render_callback' => 'vw_newspaper_customize_partial_vw_newspaper_woocommerce_single_product_page_sidebar', ) );
    ...
    $wp_customize->add_setting( 'vw_newspaper_products_button_border_radius', array(
        'default'              => 0,
        'transport'            => 'refresh',
        'sanitize_callback'    => 'vw_newspaper_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'vw_newspaper_products_button_border_radius', array(
        'label'       => esc_html__( 'Products Button Border Radius','vw-newspaper' ),
        'section'     => 'vw_newspaper_woocommerce_section',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('vw_newspaper_woocommerce_sale_font_size',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_newspaper_woocommerce_sale_font_size',array(
        'label' => __('Sale Font Size','vw-newspaper'),
        'description'   => __('Enter a value in pixels. Example:20px','vw-newspaper'),
        'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-newspaper' ),
        ),
    ...
    $wp_customize->add_setting( 'vw_newspaper_woocommerce_sale_border_radius', array(
        'default'              => '100',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'vw_newspaper_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'vw_newspaper_woocommerce_sale_border_radius', array(
        'label'       => esc_html__( 'Sale Border Radius','vw-newspaper' ),
        'section'     => 'vw_newspaper_woocommerce_section',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
...
final class VW_Newspaper_Customize {
	...
	public function sections( $manager ) {
		...
		// Register sections.
		$manager->add_section(new VW_Newspaper_Customize_Section_Pro($manager,'vw_newspaper_upgrade_pro_link',array(
			'priority'   => 1,
		...
		// Register sections.
		$manager->add_section(new VW_Newspaper_Customize_Section_Pro($manager,'vw_newspaper_get_started_link',array(
			'priority'   => 1,
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'vw-newspaper-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'vw-newspaper-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/css/customize-controls.css' );
	}
}
