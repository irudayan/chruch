...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'styx' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'styx' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'styx' ),
			'200'       => esc_html__( 'Light 200', 'styx' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'styx' ),
			'300'       => esc_html__( 'Book 300', 'styx' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'styx' ),
			'400'       => esc_html__( 'Normal 400', 'styx' ),
			'regular'   => esc_html__( 'Normal 400', 'styx' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'styx' ),
			'500'       => esc_html__( 'Medium 500', 'styx' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'styx' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'styx' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'styx' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'styx' ),
			'700'       => esc_html__( 'Bold 700', 'styx' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'styx' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'styx' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'styx' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'styx' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'styx' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'styx' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'styx' ),
		);
	}
