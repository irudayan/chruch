	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'styx' ),
				'remove'               => esc_html__( 'Remove', 'styx' ),
				'default'              => esc_html__( 'Default', 'styx' ),
				'selectFile'           => esc_html__( 'Select File', 'styx' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'styx' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'styx' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'styx' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'styx' ),
			)
		);
