...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'styx' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'styx' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'styx' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'styx' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'styx' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'styx' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'styx' ); ?>',
} );
#>
