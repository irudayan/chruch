...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'styx' ),
				'change'       => esc_html__( 'Change image', 'styx' ),
				'default'      => esc_html__( 'Default', 'styx' ),
				'remove'       => esc_html__( 'Remove', 'styx' ),
				'placeholder'  => esc_html__( 'No image selected', 'styx' ),
				'frame_title'  => esc_html__( 'Select image', 'styx' ),
				'frame_button' => esc_html__( 'Choose image', 'styx' ),
			)
		);
	}
